...
- **Symbols:** 897
- **Modules:** 3
- **Last updated:** 2026-03-24T18:45:07.145Z

## Architecture

**Modules (3):**
- **datacortex-core** (45 files, 14279 lines) — rust
...
- `crates/datacortex-core/src/format/mod.rs` — 13 changes, VOLATILE
...
- `crates/datacortex-core/src/format/transform.rs` — 10 changes, VOLATILE
...
- `crates/datacortex-core/src/format/mod.rs` ↔ `crates/datacortex-core/src/format/transform.rs` — 10 co-changes (77%)

...
### Architecture
**datacortex** — rust — 50 files, 1037 symbols
- **Modules (3):** datacortex-core (18925loc), datacortex-neural (773loc), datacortex-cli (642loc)

### Risk Map
**High-risk files:**
- `CLAUDE.md` — 18 changes, volatile
- `crates/datacortex-core/src/codec.rs` — 16 changes, volatile, coupled to: lib.rs ⚠, main.rs ⚠

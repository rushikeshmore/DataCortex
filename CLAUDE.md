...
### Risk Map
**High-risk files:**
- `CLAUDE.md` — 28 changes, 1 bug-fixes, volatile
- `.codecortex/constitution.md` — 23 changes, 1 bug-fixes, volatile
- `.codecortex/cortex.yaml` — 23 changes, 1 bug-fixes, volatile
- `.codecortex/graph.json` — 23 changes, 1 bug-fixes, volatile
- `.codecortex/hotspots.md` — 23 changes, 1 bug-fixes, volatile
...
- `Cargo.toml` ↔ `crates/datacortex-core/Cargo.toml` (89% co-change)
